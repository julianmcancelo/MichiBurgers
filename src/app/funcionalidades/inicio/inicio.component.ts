...
import { Subject, interval, combineLatest, startWith, switchMap, map, takeUntil, shareReplay } from 'rxjs';
...
export class InicioComponent implements OnDestroy {
  constructor(private auth: AuthService, private salonApi: MapaSalonApiService) {}
